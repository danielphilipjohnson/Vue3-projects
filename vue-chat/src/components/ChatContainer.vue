    ...
    <template v-else>
      ...
      >
        ...
        <p class="max-w-md">
          ...
          distinctio quia perspiciatis perferendis ullam, labore iure impedit
          laudantium dignissimos, placeat illo reprehenderit sunt doloremque
          nostrum deleniti suscipit nobis accusantium? Accusantium. Voluptatem
          neque consectetur unde ipsum aut mollitia praesentium maxime velit.
          Velit sapiente at repellendus, nemo dolore id iusto eius dolores nobis
          voluptatibus recusandae commodi maxime quaerat saepe similique aut.
        </p>
      </div>
    </template>
  </div>
